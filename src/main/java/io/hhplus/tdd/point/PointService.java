...
public class PointService {
    ...
    public UserPoint charge(long id, long amount) {
        return lockManager.withLock(id, () -> {
            ...
            pointHistoryRepository.save(new PointHistory(0, id, amount, TransactionType.CHARGE, updatedAt));
            return userPointRepository.save(new UserPoint(id, point, updatedAt));
        });
    }
    ...
    public UserPoint use(long id, long amount) {
        return lockManager.withLock(id, () -> {
            ...
            long updatedAt = System.currentTimeMillis();
            pointHistoryRepository.save(new PointHistory(0, id, amount, TransactionType.USE, updatedAt));
            return userPointRepository.save(new UserPoint(userPointCurrent.id(), point, updatedAt));
        });
    }
}
